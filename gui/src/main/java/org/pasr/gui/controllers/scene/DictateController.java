...
import org.pasr.model.asr.Configuration;
...
import org.pasr.utilities.recorder.BufferedRecorder;
...
public class DictateController extends Controller implements Observer {
    ...
    private class SetCorpusThread extends Thread {
        ...
        public void run () {
            ...
            Configuration recognizerConfiguration = new Configuration();
            ...
            try {
                ...
                realTimeSpeechRecognizer_ = new RealTimeSpeechRecognizer(null);
                ...
                streamSpeechRecognizer_ = new StreamSpeechRecognizer(null);
            } catch (IOException e) {
        ...
        private String getDefaultAcousticModelPath () throws FileNotFoundException {
            String path = Configuration.DEFAULT_CONFIGURATION.getAcousticModelPath();
